...
# md5crypt is taken from the Python Cookbook
# http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/325204
# Title: passwd-file-compatible ($1$) MD5 crypt
# Submitter: Mark Johnston
# Last Updated: 2004/10/26

# Modified to create own salt by David M. Cooke, 2005-02-02
